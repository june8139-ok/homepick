import type {
  ...
  export const metadata: Metadata = {
    ...
    description:
      "홈픽 분양정보, 청약정보, 방문예약과 상담 서비스 이용조건을 안내합니다.",
  ...
  const sections = [
    {
      ...
      paragraphs: [
        "이 약관은 홈픽(HomePick, 이하 “홈픽”)이 제공하는 분양정보, 청약정보, 아파트 검색·비교, 방문예약, 청약 알림 및 상담 연결 서비스의 이용조건과 운영자 및 이용자의 권리·의무를 정하는 것을 목적으로 합니다.",
      ],
    },
  
    {
      ...
      paragraphs: [
        "홈픽은 전국 아파트와 분양 단지에 관한 정보 검색, 지역별 탐색, 단지 비교, 청약 일정 확인, 방문예약 및 상담 신청 기능을 제공합니다.",
  ...
  
    {
      ...
      paragraphs: [
        "홈픽에서 제공하는 분양가, 계약조건, 잔여세대, 청약일정, 입주예정일, 교통·교육·생활환경 및 개발계획 등의 정보는 공공데이터, 모집공고, 시행사·시공사·분양 관계자와 공개자료 등을 바탕으로 정리한 참고 정보입니다.",
        "정보는 작성 또는 수집 이후 변경될 수 있으며, 홈픽이 특정 단지의 계약조건, 분양 가능 여부, 프리미엄, 수익 또는 미래가치를 보장하는 것은 아닙니다.",
  ...
  
    {
      ...
      paragraphs: [
        ...
        "이용자가 개인정보 제3자 제공에 동의한 경우 홈픽은 신청한 단지의 시행사, 분양대행사, 모델하우스 또는 지정 상담 담당자에게 상담과 안내에 필요한 최소한의 정보를 전달할 수 있습니다.",
  ...
  
    {
      ...
      list: [
        ...
        "홈픽의 서버, 데이터베이스 또는 관리자 기능에 비정상적으로 접근하지 않을 것",
  ...
  
    {
      ...
      paragraphs: [
        "홈픽은 시스템 점검, 장애, 호스팅 또는 데이터 제공처의 문제, 천재지변, 관계 법령의 변경 등 불가피한 사유가 있는 경우 서비스의 전부 또는 일부를 변경하거나 일시 중단할 수 있습니다.",
  ...
  
    {
      ...
      paragraphs: [
        "홈픽은 청약홈, 지도, 카카오톡, 전화 또는 제3자 웹사이트로 연결되는 링크를 제공할 수 있습니다.",
  ...
  
    {
      ...
      paragraphs: [
        "홈픽이 직접 제작한 화면 구성, 문구, 데이터 정리 방식, 로고와 콘텐츠에 대한 권리는 홈픽 또는 정당한 권리자에게 있습니다.",
        "공공데이터, 시행사 제공자료, 단지 이미지와 상표 등 제3자의 자료에 대한 권리는 각각의 권리자에게 있으며, 홈픽은 출처와 이용조건을 존중합니다.",
      ],
    },
  
    {
      ...
      paragraphs: [
        "홈픽은 고의 또는 중대한 과실이 없는 한 외부 정보 제공처의 오류, 정보 변경, 통신 장애 또는 이용자가 최종 확인 없이 정보를 사용하여 발생한 손해에 대해 책임을 부담하지 않습니다.",
        "홈픽의 정보는 부동산 계약, 투자, 법률, 세무 또는 금융 자문을 대신하지 않습니다. 중요한 의사결정은 관련 전문가와 공식 기관의 확인을 거쳐야 합니다.",
        "이 조항은 관련 법령상 홈픽이 부담해야 하는 책임을 부당하게 면제하거나 제한하는 의미로 적용되지 않습니다.",
      ],
    },
  
    {
      ...
      paragraphs: [
        "홈픽은 서비스 이용 과정에서 처리하는 개인정보를 개인정보 보호법 등 관련 법령과 개인정보처리방침에 따라 보호합니다.",
      ],
    },
  
    {
      ...
      paragraphs: [
        "홈픽은 관계 법령 또는 서비스 내용의 변경에 따라 이 약관을 수정할 수 있습니다.",
